...
DATA_FOLDER = os.path.join(BASE_DIR, "data", "ncct")
...
# Predefined learners and their NCCT certificates
learners_certificates = {
    "Alice Johnson": ["Medical Assistant - NCMA"],
    "Bob Smith": ["Phlebotomy Technician - NCPT"],
    "Charlie Lee": ["Patient Care Technician"],
    "Diana Patel": ["Medical Assistant - NCMA", "Patient Care Technician"],
    "Ethan Brown": ["Phlebotomy Technician - NCPT"],
    "Fiona Williams": ["Patient Care Technician"],
    "George Martin": ["Medical Assistant - NCMA"]
}

def generate_certificate_data(learner_name, course_title, index):
    certificate_id = f"NCCT-{index+2000}"
    ...
    cert_data.update({
        ...
        "certificate_title": "Certificate of Competency",
        "course_title": course_title,
        "completion_date": completion_date,
        "verification_url": f"https://ncct.org/verify/{certificate_id}",
        "metadata": {
            **base_schema["metadata"],
            "organization_name": "NCCT",
            "organization_logo": "ncct_logo.png",
            "issue_date": completion_date,
            "accreditation_info": "NCCA Accredited",
            "signatories": ["NCCT Official"],
            "skill_level": "Competency Level",
...
def generate_pdf(cert_data):
    ...
    pdf.cell(0, 15, "NCCT", ln=True, align="C")
    pdf.set_font("Arial", "", 20)
    pdf.cell(0, 15, cert_data["certificate_title"], ln=True, align="C")
    pdf.set_font("Arial", "", 16)
    pdf.ln(10)
    pdf.multi_cell(0, 10, f"This certifies that {cert_data['learner_name']} has achieved competency in:", align="C")
